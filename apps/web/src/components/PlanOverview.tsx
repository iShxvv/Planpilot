          ...
          <div className={styles.columnHeader}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <button
                ...
                onClick={() => onSendAction("Please regenerate the Run Sheet (Schedule) specifically to align with my booked services. Ensure arrival times, service durations, and locations match the selected vendors.")}
                title="Sync with Booked Services"
              >
                Sync
              </button>
